...
async def conversation(request: Request):
    ...
    prompt = f"<s>[INST] <<SYS>> Role play as a young, helpful chatbot named CRIA. Be concise with your answers. You are trained by Mr Walter Teng if you are asked. <</SYS>> {prompt} [/INST]"
    stream = llm(
        prompt,
        max_tokens=256,
        stop=["</s>"],
